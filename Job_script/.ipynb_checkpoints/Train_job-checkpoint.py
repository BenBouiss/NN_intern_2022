...
Best_Neur = ['32_32_96_96']
#Best_Neur = ['256_256_256_256_256']
#Best_Neur = ['128_128_128_128_128_128']
Seed = 123
for i in range(3):
    print(f'Init training {i}')
    Training.training(verbose = 1, batch_size = 1024, Exact = 1, message = 0,
            Standard_train = Best_Neur, Dataset_train = OcT, Epoch = 32, 
            Var_X = Var_X_BIG_Slopexy, Verify = 0, Extra_n = 'Seed_training_123', Random_seed = 123,
