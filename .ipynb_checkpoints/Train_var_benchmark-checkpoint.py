...
for var in Uniq_var[-1:]:
    ...
    li = ['iceDraft', 'bathymetry', 'Slope_iceDraft_x', 'Slope_bathymetry_x',
                   'Slope_iceDraft_y', 'Slope_bathymetry_y',
                  'Distances_ground_line', 'Distances_front_line']    
    ...
    Training.training(training_extent = 0, verbose = 1, batch_size = 1024, Exact = 1, message = 1,
                Standard_train = Best_Neur, Dataset_train = OcT, Epoch = 60, 
                Var_X = li, Verify = 0, Extra_n = 'Drop_Var_bench',
